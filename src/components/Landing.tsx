  ...
  const features = [
    {
      ...
      desc: 'جدولة ١٢٨ بنكًا كميًا كاملاً بالتساوي على أيام دراستك، بمعدل نصف ساعة إلى ساعة للبنك الواحد.',
      icon: Award,
    },
    {
      title: 'تقسيم لفظي شامل',
      desc: 'توزيع ٣٠١ قسمًا لفظيًا متكاملاً لتبسيط استيعاب مهارات التناظر، إكمال الجمل، والوعي القرائي.',
      icon: BookOpen,
    },
    {
